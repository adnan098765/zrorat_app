...
class ArchitecturalScreen extends StatefulWidget {
  const ArchitecturalScreen({super.key});

  @override
  State<ArchitecturalScreen> createState() => _ArchitecturalScreenState();
}

class _ArchitecturalScreenState extends State<ArchitecturalScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text("Architectural Services"),
        centerTitle: true,
      ),
